...
const ActiveTripMockup = () => (
    <div className="bg-white">
        ...
        <div className="p-3 sm:p-4 space-y-3 bg-gradient-to-b from-indigo-50 to-white">
            ...
            {/* Map preview */}
            <div className="rounded-xl border border-gray-100 bg-gradient-to-br from-blue-50 via-white to-indigo-50 p-3 relative h-24 overflow-hidden">
    ...
    <div className="bg-white">
        ...
        <div className="p-3 sm:p-4 space-y-3 bg-gradient-to-b from-orange-50 to-white">
            <div className="flex justify-between items-center">
                ...
                <span className="text-[9px] px-2 py-0.5 bg-indigo-50 text-brand-primary rounded-full font-semibold">2 Done</span>
            </div>
            {[
                { t: "08:00", n: "Airport Pickup", a: "Globex Group · 4 pax", st: "done", c: "text-brand-primary bg-indigo-50" },
            ...
            <div className="rounded-xl border border-gray-100 bg-white p-3 shadow-sm">
                ...
                {[
                    ...
                    <div key={i} className="flex items-center gap-2 py-1 border-t border-gray-50 first:border-0 text-[10px]">
                        <div className={`w-5 h-5 rounded-md flex items-center justify-center ${c.ok ? "bg-indigo-50 text-brand-primary" : "bg-gray-100 text-gray-400"}`}>
        ...
        <div className="p-3 sm:p-4 space-y-3 bg-gradient-to-b from-purple-50 to-white">
                ...
                <div className="flex items-end justify-between h-16 gap-1">
                    {[40, 60, 30, 80, 70, 90, 55].map((h, i) => (
                        <div key={i} className="flex-1 flex flex-col items-center gap-0.5">
                            <div className="w-full bg-gradient-to-t from-brand-primary to-indigo-300 rounded-sm" style={{ height: `${h}%` }}></div>
            ...
            <div className="grid grid-cols-2 gap-2">
                ...
                <div className="rounded-lg border border-gray-100 bg-white p-2">
                    ...
                    <p className="text-base font-bold text-indigo-600">$140</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <main className="pt-[60px] md:pt-20 bg-white font-sans overflow-hidden">
            ...
            <section className="py-[72px] bg-gradient-to-br from-brand-primary to-indigo-800 text-white text-center relative overflow-hidden">
                ...
                <div className="max-w-3xl mx-auto px-6 relative z-10 space-y-6 sm:space-y-8" data-aos="zoom-in">
                    ...
                    <p className="text-base sm:text-xl text-indigo-50 font-light">Calm dashboards, clear assignments, and earnings they can trust — every trip, every day.</p>
