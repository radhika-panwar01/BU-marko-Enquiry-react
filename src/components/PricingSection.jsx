...
const PricingSection = ({ onOpenInquiry, plans, title = "Flexible Pricing for Every Business", subtitle = "Choose the right plan for your needs and scale as you grow." }) => {
    ...
    return (
        <section id="pricing" className="py-[72px] bg-white" data-aos="fade-up" data-aos-duration="1000">
            ...
            <div className="flex justify-center mb-16">
                <div className="relative grid grid-cols-2 items-center bg-brand-light border border-gray-100 rounded-full p-1 shadow-sm w-[280px] sm:w-[320px]">
                    ...
                    <button
                        ...
                        className={`relative z-10 py-2.5 text-sm font-semibold rounded-full transition-colors duration-300 ${
                    ...
                    <button
                        ...
                        className={`relative z-10 py-2.5 text-sm font-semibold rounded-full transition-colors duration-300 flex items-center justify-center gap-2 ${
                            isAnnual ? 'text-white' : 'text-brand-dark'
                        }`}
                    >
                        Annually
            ...
            <div className="mx-3 px-4 md:px-10 lg:px-14 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-6 items-stretch">
                            ...
                            <div className="mb-4 min-h-[64px] flex items-end">
                                {plan.custom ? (
                                    ...
                                    <>
                                        ...
                                        <div
                                            className={`text-[10px] ml-2 mb-1.5 leading-tight font-medium uppercase tracking-wide ${
                                                isHighlight ? 'text-white/80' : 'text-brand-gray'
                                            }`}
                                        >
                                            <span>per user</span>
                                            <br />
                            ...
                            <div className="mb-8">
                                <p
                                    className={`text-sm leading-relaxed ${
                                        isHighlight ? 'text-white/90' : 'text-brand-gray font-light'
                                    }`}
                                >
                                    {plan.tagline}
                                </p>
                            ...
                            <ul className="space-y-4 flex-grow">
                                {plan.features.map((feature, idx) => (
                                    <li key={idx} className="flex items-start gap-3">
                                        <i
                                            className={`fa-solid fa-circle-check mt-1 text-sm ${
